<template>
  <div class="page">
    ...
    <div class="pos-box">
      ...
      <div class="card">
        <div class="card-tab">
          <span class="card-tab-item"
            :class="[activeid == 0 ? 'actived' :'']">信用卡分期</span>
        </div>
        <div class="card-item">
...
export default {
  ...
  mounted () {
    this.orderAmt = this.$utils.getUrlKey('orderAmt');
    this.storeId = this.$utils.getUrlKey('storeId');
